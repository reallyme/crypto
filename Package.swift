...
//
//     .package(url: "https://github.com/reallyme/crypto", from: "0.3.9")
...
let ffiArtifactChecksum = "d6f6d033b4b051ff1dcaf55fcf84aa016813d815c6032b1ee550e4c3461bdada"
let ffiArtifactVersion = "0.3.9"
  ...
  if ffiArtifactLocalPathOverride.isEmpty {
    packageTargets.append(
      .binaryTarget(
        ...
        url:
          "https://github.com/reallyme/crypto/releases/download/v\(ffiArtifactVersion)/ReallyMeCryptoFFI.xcframework.zip",
