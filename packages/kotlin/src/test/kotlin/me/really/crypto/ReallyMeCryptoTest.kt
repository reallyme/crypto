...
class ReallyMeCryptoTest {
    ...
    private fun nativeAeadMethod(name: String): java.lang.reflect.Method =
    ...
    private fun nativeEnvelope(status: ReallyMeNativeStatus, payload: ByteArray = ByteArray(0)): ByteArray =
        nativeEnvelope(status.code, payload)

    private fun nativeEnvelope(statusCode: Int, payload: ByteArray): ByteArray =
        byteArrayOf(
    ...
    private fun malformedDerEcdsaSignature(): ByteArray =
        DERSequence(
