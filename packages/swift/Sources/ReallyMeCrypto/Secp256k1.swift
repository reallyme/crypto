...
public enum ReallyMeSecp256k1 {
  ...
  /// a valid scalar.
  public static func generateKeyPair() throws(ReallyMeCryptoError) -> (
    publicKey: [UInt8], secretKey: [UInt8]
  ) {
    ...
    return try generateKeyPair(
      ...
      derivePublicKey: { candidate throws(ReallyMeCryptoError) in
  ...
  static func generateKeyPair(
    ...
    derivePublicKey: ([UInt8]) throws(ReallyMeCryptoError) -> [UInt8],
    didClear: (([UInt8]) -> Void)? = nil
  ) throws(ReallyMeCryptoError) -> (publicKey: [UInt8], secretKey: [UInt8]) {
  ...
  public static func deriveKeyPair(secretKey: [UInt8]) throws(ReallyMeCryptoError) -> (
    publicKey: [UInt8], secretKey: [UInt8]
  ) {
    (
  ...
  public static func derivePublicKey(secretKey: [UInt8]) throws(ReallyMeCryptoError) -> [UInt8] {
  ...
  public static func decompressPublicKey(publicKey: [UInt8]) throws(ReallyMeCryptoError) -> [UInt8]
  {
  ...
  public static func sign(message: [UInt8], secretKey: [UInt8]) throws(ReallyMeCryptoError)
    -> [UInt8]
  {
    guard secretKey.count == secretKeyLength else {
      throw ReallyMeCryptoError.invalidInput
  ...
  private static func makeContext(flags: UInt32, randomize: Bool) throws(ReallyMeCryptoError)
    -> OpaquePointer
  {
