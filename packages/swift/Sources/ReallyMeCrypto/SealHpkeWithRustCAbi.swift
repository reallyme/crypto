...
private typealias HpkeSealBaseFunction =
  @convention(c) (
    UInt32,
    UnsafePointer<UInt8>?,
    Int,
...
private typealias HpkeOpenBaseFunction =
  @convention(c) (
    UInt32,
    UnsafePointer<UInt8>?,
    Int,
...
public struct ReallyMeRustCAbiHpke: Sendable {
  ...
  public func sealBase(
    ...
    guard ciphertextLength.overflow == false else {
      throw ReallyMeCryptoError.invalidInput
    }
  ...
  public func openBase(
    ...
    guard plaintextLengthLimit.overflow == false else {
      throw ReallyMeCryptoError.invalidInput
    }
  ...
  private func rustSuite(for suite: ReallyMeHpkeSuite) throws(ReallyMeCryptoError)
    -> RustCAbiHpkeSuite
  {
    switch suite {
