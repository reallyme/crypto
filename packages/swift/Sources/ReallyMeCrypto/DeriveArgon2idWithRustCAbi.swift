...
private typealias Argon2idDeriveKeyFunction =
  @convention(c) (
    UInt32,
    UnsafePointer<UInt8>?,
    Int,
...
public struct ReallyMeRustCAbiArgon2id: Sendable {
  ...
  public func deriveKey(kdfVersion: UInt32, secret: [UInt8], salt: [UInt8])
    throws(ReallyMeCryptoError) -> [UInt8]
  {
    ...
    do {
      ...
      ReallyMeCryptoMemory.bestEffortClear(&derivedKey)
      throw error
    }
    return derivedKey
  }
...
extension ReallyMeCrypto {
  public static func deriveArgon2idKey(
    kdfVersion: UInt32,
    secret: [UInt8],
    salt: [UInt8],
