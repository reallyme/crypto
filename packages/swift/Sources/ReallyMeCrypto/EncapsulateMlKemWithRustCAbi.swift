...
private typealias MlKemGenerateKeyPairFunction =
  @convention(c) (
...
private typealias MlKemDeriveKeyPairFunction =
  @convention(c) (
    UnsafePointer<UInt8>?,
    Int,
    UnsafeMutablePointer<UInt8>?,
...
private typealias MlKemEncapsulateFunction =
  @convention(c) (
    UnsafePointer<UInt8>?,
    Int,
    UnsafeMutablePointer<UInt8>?,
...
private typealias MlKemDecapsulateFunction =
  @convention(c) (
    UnsafePointer<UInt8>?,
    Int,
    UnsafePointer<UInt8>?,
...
public struct ReallyMeRustCAbiMlKem: Sendable {
  ...
  public func deriveKeyPair(_ algorithm: ReallyMeKemAlgorithm, secretKey: [UInt8])
