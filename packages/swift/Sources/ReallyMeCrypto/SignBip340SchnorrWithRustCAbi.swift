...
private typealias Bip340SchnorrDerivePublicKeyFunction =
  @convention(c) (
    UnsafePointer<UInt8>?,
    Int,
...
private typealias Bip340SchnorrSignFunction =
  @convention(c) (
    UnsafePointer<UInt8>?,
    Int,
    UnsafePointer<UInt8>?,
...
private typealias Bip340SchnorrVerifyFunction =
  @convention(c) (
    UnsafePointer<UInt8>?,
    Int,
    UnsafePointer<UInt8>?,
...
public struct ReallyMeRustCAbiBip340Schnorr: Sendable {
  ...
  public func derivePublicKey(secretKey: [UInt8]) throws(ReallyMeCryptoError) -> [UInt8] {
  ...
  public func sign(message32: [UInt8], secretKey: [UInt8], auxRand32: [UInt8])
  ...
  public func verify(signature: [UInt8], message32: [UInt8], publicKeyXOnly: [UInt8])
...
extension ReallyMeCrypto {
  public static func deriveBip340SchnorrPublicKey(
    secretKey: [UInt8],
