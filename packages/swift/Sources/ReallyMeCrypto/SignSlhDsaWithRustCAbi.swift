...
private typealias SlhDsaGenerateKeyPairFunction =
  @convention(c) (
...
private typealias SlhDsaDeriveKeyPairFunction =
  @convention(c) (
    UnsafePointer<UInt8>?,
    Int,
    UnsafePointer<UInt8>?,
...
private typealias SlhDsaSignFunction =
  @convention(c) (
    UnsafePointer<UInt8>?,
    Int,
    UnsafePointer<UInt8>?,
...
private typealias SlhDsaVerifyFunction =
  @convention(c) (
    UnsafePointer<UInt8>?,
    Int,
    UnsafePointer<UInt8>?,
...
public struct ReallyMeRustCAbiSlhDsa: Sendable {
  ...
  public func generateKeyPair(_ algorithm: ReallyMeSignatureAlgorithm) throws(ReallyMeCryptoError)
  ...
  private func requireSlhDsaSha2_128s(_ algorithm: ReallyMeSignatureAlgorithm)
    throws(ReallyMeCryptoError)
  {
    switch algorithm {
...
extension ReallyMeCrypto {
  public static func deriveSlhDsaSha2_128sKeyPair(
    skSeed: [UInt8],
    skPrf: [UInt8],
    pkSeed: [UInt8],
