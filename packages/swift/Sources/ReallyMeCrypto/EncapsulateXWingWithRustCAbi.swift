...
private typealias XWingGenerateKeyPairFunction =
  @convention(c) (
...
private typealias XWingDeriveKeyPairFunction =
  @convention(c) (
    UnsafePointer<UInt8>?,
    Int,
    UnsafeMutablePointer<UInt8>?,
...
private typealias XWingEncapsulateFunction =
  @convention(c) (
    UnsafePointer<UInt8>?,
    Int,
    UnsafeMutablePointer<UInt8>?,
...
private typealias XWingDecapsulateFunction =
  @convention(c) (
    UnsafePointer<UInt8>?,
    Int,
    UnsafePointer<UInt8>?,
...
public struct ReallyMeRustCAbiXWing: Sendable {
  ...
  public func generateKeyPair(_ algorithm: ReallyMeKemAlgorithm) throws(ReallyMeCryptoError)
    -> ReallyMeKemKeyPair
  {
  ...
  private func rustSuite(for algorithm: ReallyMeKemAlgorithm) throws(ReallyMeCryptoError)
    -> RustCAbiXWingSuite
  {
    switch algorithm {
    case .xWing768:
...
extension ReallyMeCrypto {
  public static func generateKemKeyPair(
    _ algorithm: ReallyMeKemAlgorithm,
  ...
  public static func deriveXWingKeyPair(
    _ algorithm: ReallyMeKemAlgorithm,
    secretKey: [UInt8],
    rustCAbiLibrary: ReallyMeRustCAbiLibrary
  ) throws(ReallyMeCryptoError) -> ReallyMeKemKeyPair {
  ...
  public static func deriveMlKemKeyPair(
    _ algorithm: ReallyMeKemAlgorithm,
    secretKey: [UInt8],
    rustCAbiLibrary: ReallyMeRustCAbiLibrary
  ) throws(ReallyMeCryptoError) -> ReallyMeKemKeyPair {
