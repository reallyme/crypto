...
public enum ReallyMeJwk {
  ...
  public static func toJwk(
    algorithm: ReallyMeJwkAlgorithm,
    publicKey: [UInt8]
  ) throws(ReallyMeCryptoError) -> ReallyMeJwkDocument {
  ...
  private static func jwkJson(_ jwk: ReallyMeJwkDocument) throws(ReallyMeCryptoError) -> String {
    switch jwk.kty {
    case "EC":
  ...
  public static func fromJwkJson(_ data: Data) throws(ReallyMeCryptoError) -> ReallyMeJwkKey {
  ...
  public static func fromJwksJson(_ data: Data) throws(ReallyMeCryptoError) -> [ReallyMeJwkKey] {
    ...
    var parsedKeys: [ReallyMeJwkKey] = []
    parsedKeys.reserveCapacity(keys.count)
    for key in keys {
      parsedKeys.append(try fromJwkObject(key))
    }
    return parsedKeys
  }

  public static func publicKeyBytes(from jwk: ReallyMeJwkDocument) throws(ReallyMeCryptoError)
    -> [UInt8]
  {
    return try fromJwkObject(object(from: jwk)).publicKey
  }

  private static func fromJwkObject(_ object: [String: Any]) throws(ReallyMeCryptoError)
    -> ReallyMeJwkKey
  {
  ...
  private static func spec(for algorithmName: String) throws(ReallyMeCryptoError) -> ReallyMeJwkSpec
  {
    switch algorithmName {
    case "Ed25519":
      return ReallyMeJwkSpec(
    ...
    case "P-256":
      return ReallyMeJwkSpec(
        alg: "ES256", crv: "P-256", kty: "EC", keyUse: "sig", publicKeyLength: 33)
    case "secp256k1":
      return ReallyMeJwkSpec(
        alg: "ES256K", crv: "secp256k1", kty: "EC", keyUse: "sig", publicKeyLength: 33)
    case "ML-DSA-44":
      return ReallyMeJwkSpec(
        alg: algorithmName, crv: nil, kty: "AKP", keyUse: "sig", publicKeyLength: 1_312)
    case "ML-DSA-65":
      return ReallyMeJwkSpec(
        alg: algorithmName, crv: nil, kty: "AKP", keyUse: "sig", publicKeyLength: 1_952)
    case "ML-DSA-87":
      return ReallyMeJwkSpec(
        alg: algorithmName, crv: nil, kty: "AKP", keyUse: "sig", publicKeyLength: 2_592)
    case "ML-KEM-512":
      return ReallyMeJwkSpec(
        alg: algorithmName, crv: nil, kty: "AKP", keyUse: "enc", publicKeyLength: 800)
    case "ML-KEM-768":
      return ReallyMeJwkSpec(
        alg: algorithmName, crv: nil, kty: "AKP", keyUse: "enc", publicKeyLength: 1_184)
    case "ML-KEM-1024":
      return ReallyMeJwkSpec(
        alg: algorithmName, crv: nil, kty: "AKP", keyUse: "enc", publicKeyLength: 1_568)
    case "SLH-DSA-SHA2-128s":
      return ReallyMeJwkSpec(
        alg: algorithmName, crv: nil, kty: "AKP", keyUse: "sig", publicKeyLength: 32)
    case "X-Wing-768":
      return ReallyMeJwkSpec(
        alg: algorithmName, crv: nil, kty: "AKP", keyUse: "enc", publicKeyLength: 1_216)
    default:
      throw ReallyMeCryptoError.unsupportedAlgorithm
    }
  }
  ...
  private static func decompressEcPublicKey(
    ...
    case .p256:
      do {
        return Array(
          try P256.Signing.PublicKey(compressedRepresentation: Data(publicKey)).x963Representation)
      } catch {
        throw ReallyMeCryptoError.invalidInput
      }
    case .secp256k1:
  ...
  private static func canonicalJsonObject(_ data: Data) throws(ReallyMeCryptoError) -> [String: Any]
  {
  ...
  private static func codecBase64urlEncode(_ bytes: [UInt8]) throws(ReallyMeCryptoError) -> String {
    do {
  ...
  private static func codecBase64urlDecode(_ encoded: String) throws(ReallyMeCryptoError) -> [UInt8]
  {
    do {
