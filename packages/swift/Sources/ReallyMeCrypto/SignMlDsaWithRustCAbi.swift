...
private typealias MlDsaGenerateKeyPairFunction =
  @convention(c) (
...
private typealias MlDsaDeriveKeyPairFunction =
  @convention(c) (
    UnsafePointer<UInt8>?,
    Int,
    UnsafeMutablePointer<UInt8>?,
...
private typealias MlDsaSignFunction =
  @convention(c) (
    UnsafePointer<UInt8>?,
    Int,
    UnsafePointer<UInt8>?,
...
private typealias MlDsaVerifyFunction =
  @convention(c) (
    UnsafePointer<UInt8>?,
    Int,
    UnsafePointer<UInt8>?,
...
public struct ReallyMeRustCAbiMlDsa: Sendable {
  ...
  private func rustSuite(for algorithm: ReallyMeSignatureAlgorithm) throws(ReallyMeCryptoError)
    -> RustCAbiMlDsaSuite
  {
    switch algorithm {
    case .mlDsa44:
