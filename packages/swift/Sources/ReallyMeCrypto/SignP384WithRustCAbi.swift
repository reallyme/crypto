...
private typealias P384GenerateKeyPairFunction =
  @convention(c) (
...
private typealias P384GenerateKeyPairFromSecretKeyFunction =
  @convention(c) (
    UnsafePointer<UInt8>?,
    Int,
    UnsafeMutablePointer<UInt8>?,
...
private typealias P384SignDerPrehashFunction =
  @convention(c) (
    UnsafePointer<UInt8>?,
    Int,
    UnsafePointer<UInt8>?,
...
private typealias P384VerifyDerPrehashFunction =
  @convention(c) (
    UnsafePointer<UInt8>?,
    Int,
    UnsafePointer<UInt8>?,
...
public struct ReallyMeRustCAbiP384Ecdsa: Sendable {
  ...
  {
    guard
      publicKey.count == rustCAbiP384CompressedPublicKeyLength
