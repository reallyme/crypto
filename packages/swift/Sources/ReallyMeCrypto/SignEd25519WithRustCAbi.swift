...
private typealias Ed25519GenerateKeyPairFunction =
  @convention(c) (
...
private typealias Ed25519GenerateKeyPairFromSeedFunction =
  @convention(c) (
    UnsafePointer<UInt8>?,
    Int,
    UnsafeMutablePointer<UInt8>?,
...
private typealias Ed25519SignFunction =
  @convention(c) (
    UnsafePointer<UInt8>?,
    Int,
    UnsafePointer<UInt8>?,
...
private typealias Ed25519VerifyFunction =
  @convention(c) (
    UnsafePointer<UInt8>?,
    Int,
    UnsafePointer<UInt8>?,
...
extension ReallyMeCrypto {
  ...
  public static func deriveMlDsaKeyPair(
    _ algorithm: ReallyMeSignatureAlgorithm,
    secretKey: [UInt8],
    rustCAbiLibrary: ReallyMeRustCAbiLibrary
  ) throws(ReallyMeCryptoError) -> ReallyMeSignatureKeyPair {
