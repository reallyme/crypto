...
private typealias P521GenerateKeyPairFunction =
  @convention(c) (
...
private typealias P521GenerateKeyPairFromSecretKeyFunction =
  @convention(c) (
    UnsafePointer<UInt8>?,
    Int,
    UnsafeMutablePointer<UInt8>?,
...
private typealias P521SignDerPrehashFunction =
  @convention(c) (
    UnsafePointer<UInt8>?,
    Int,
    UnsafePointer<UInt8>?,
...
private typealias P521VerifyDerPrehashFunction =
  @convention(c) (
    UnsafePointer<UInt8>?,
    Int,
    UnsafePointer<UInt8>?,
...
public struct ReallyMeRustCAbiP521Ecdsa: Sendable {
  ...
  {
    guard
      publicKey.count == rustCAbiP521CompressedPublicKeyLength
