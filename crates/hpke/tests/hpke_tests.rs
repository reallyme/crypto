...
use crypto_hpke::{
    open_base, seal_base, HpkeAeadId, HpkeError, HpkeKdfId, HpkeKemId, HpkeOpenRequest,
    HpkeSealRequest, HpkeSuite, HPKE_DHKEM_P256_HKDF_SHA256_AES256GCM,
    HPKE_DHKEM_X25519_HKDF_SHA256_CHACHA20POLY1305, HPKE_KEM_ML_KEM_1024_P384,
...
#[test]
fn mlkem1024_p384_hpke_kem_uses_registered_boundary() {
    assert_eq!(HPKE_KEM_ML_KEM_1024_P384, 0x0051);
    assert_eq!(HpkeKemId::try_from(0x0051), Ok(HpkeKemId::MlKem1024P384));
