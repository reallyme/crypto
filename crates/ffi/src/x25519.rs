...
use crate::status::{CryptoStatus, CRYPTO_INTERNAL_ERROR, CRYPTO_INVALID_KEY, CRYPTO_OK};
...
pub unsafe extern "C" fn rm_crypto_x25519_generate_keypair(
    ...
    ffi_guard(|| {
        ...
        let key_pair = match reallyme_crypto::operations::key_agreement::generate_key_pair(
            Algorithm::X25519,
        ) {
            Ok(value) => value,
...
pub unsafe extern "C" fn rm_crypto_x25519_generate_keypair_from_seed(
    ...
    ffi_guard(|| {
        ...
        let key_pair = match reallyme_crypto::operations::key_agreement::derive_key_pair(
            Algorithm::X25519,
            seed,
        ) {
            Ok(value) => value,
