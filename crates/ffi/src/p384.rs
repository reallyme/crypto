...
use reallyme_crypto::p384 as crypto_p384;
...
pub unsafe extern "C" fn rm_crypto_p384_generate_keypair(
    ...
    ffi_guard(|| {
        ...
        let key_pair =
            match reallyme_crypto::operations::signature::generate_key_pair(Algorithm::P384) {
                Ok(value) => value,
...
pub unsafe extern "C" fn rm_crypto_p384_compress_public_key(
    ...
    ffi_guard(|| {
        ...
        match key_encoding::compress_p384_public_key(public_key) {
...
pub unsafe extern "C" fn rm_crypto_p384_decompress_public_key(
    ...
    ffi_guard(|| {
        ...
        match key_encoding::decompress_p384_public_key(public_key) {
            Ok(value) => unsafe { write_fixed(out, out_len, &value) },
            Err(_) => CRYPTO_INVALID_KEY,
        }
    })
