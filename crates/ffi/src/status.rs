...
///
/// Functions return `0` on success and negative values for ABI or primitive
/// failures. Executable protobuf entry points return operation failures only
/// inside their binary result envelope; they never introduce a positive
