...
/// Length in bytes of a SHA3-256 digest (32).
pub const SHA3_256_DIGEST_LEN: usize = reallyme_crypto::sha3::SHA3_256_DIGEST_LENGTH;

/// Computes the SHA3-256 digest of `message` and writes it to `digest_out`.
///
/// # Safety
///
...
/// [`SHA3_256_DIGEST_LEN`] (32). Returns [`CRYPTO_OK`] on success or a negative
/// [`CryptoStatus`] error code (e.g. buffer too small); the status is the
/// return value.
#[no_mangle]
pub unsafe extern "C" fn rm_crypto_sha3_256_digest(
    message: *const u8,
    message_len: usize,
    digest_out: *mut u8,
