...
pub unsafe extern "C" fn rm_crypto_ml_kem_512_generate_keypair(
    ...
    ffi_guard(|| {
        ...
        let key_pair =
            match reallyme_crypto::operations::kem::generate_key_pair(Algorithm::MlKem512) {
                Ok(value) => value,
...
pub unsafe extern "C" fn rm_crypto_ml_kem_512_encapsulate(
    ...
    ffi_guard(|| {
        ...
        let encapsulation =
            match reallyme_crypto::operations::kem::encapsulate(Algorithm::MlKem512, public_key) {
                Ok(value) => value,
