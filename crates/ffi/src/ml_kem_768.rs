...
pub unsafe extern "C" fn rm_crypto_ml_kem_768_generate_keypair(
    ...
    ffi_guard(|| {
        ...
        let key_pair =
            match reallyme_crypto::operations::kem::generate_key_pair(Algorithm::MlKem768) {
                Ok(value) => value,
...
pub unsafe extern "C" fn rm_crypto_ml_kem_768_encapsulate(
    ...
    ffi_guard(|| {
        ...
        let encapsulation =
            match reallyme_crypto::operations::kem::encapsulate(Algorithm::MlKem768, public_key) {
                Ok(value) => value,
...
pub unsafe extern "C" fn rm_crypto_ml_kem_768_encode_public_key(
    ...
    ffi_guard(|| {
        ...
        match key_encoding::copy_fixed_public_key(public_key, ML_KEM_768_PUBLIC_KEY_LEN) {
