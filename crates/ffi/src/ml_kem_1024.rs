...
pub unsafe extern "C" fn rm_crypto_ml_kem_1024_generate_keypair(
    ...
    ffi_guard(|| {
        ...
        let key_pair =
            match reallyme_crypto::operations::kem::generate_key_pair(Algorithm::MlKem1024) {
                Ok(value) => value,
...
pub unsafe extern "C" fn rm_crypto_ml_kem_1024_encapsulate(
    ...
    ffi_guard(|| {
        ...
        let encapsulation =
            match reallyme_crypto::operations::kem::encapsulate(Algorithm::MlKem1024, public_key) {
                Ok(value) => value,
...
/// [`crate::status::CRYPTO_INVALID_CIPHERTEXT`] for a bad ciphertext length or
/// decapsulation error. The caller owns the secret copy in `shared_secret_out`
/// and must zeroize it.
#[no_mangle]
...
pub unsafe extern "C" fn rm_crypto_ml_kem_1024_encode_public_key(
    ...
    ffi_guard(|| {
        ...
        match key_encoding::copy_fixed_public_key(public_key, ML_KEM_1024_PUBLIC_KEY_LEN) {
