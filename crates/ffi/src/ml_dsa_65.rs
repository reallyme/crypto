...
pub unsafe extern "C" fn rm_crypto_ml_dsa_65_generate_keypair(
    ...
    ffi_guard(|| {
        ...
        let key_pair =
            match reallyme_crypto::operations::signature::generate_key_pair(Algorithm::MlDsa65) {
                Ok(value) => value,
...
pub unsafe extern "C" fn rm_crypto_ml_dsa_65_sign(
    ...
    ffi_guard(|| {
        ...
        match reallyme_crypto::operations::signature::sign(Algorithm::MlDsa65, secret_seed, message)
        {
...
pub unsafe extern "C" fn rm_crypto_ml_dsa_65_encode_public_key(
    ...
    ffi_guard(|| {
        ...
        match key_encoding::copy_fixed_public_key(public_key, ML_DSA_65_PUBLIC_KEY_LEN) {
