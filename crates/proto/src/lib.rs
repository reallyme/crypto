...
/// Strict codecs for the generated operation response boundary.
#[cfg(feature = "generated")]
pub mod operation_response_wire;

/// Strict codecs for the generated operation request boundary.
#[cfg(feature = "generated")]
pub mod operation_request_wire;
