...
pub unsafe extern "C" fn rm_crypto_ml_dsa_44_generate_keypair(
    ...
    ffi_guard(|| {
        ...
        let (public, secret) =
            match crypto_ml_dsa_44::generate_ml_dsa_44_keypair().into_keypair_result() {
                Ok(value) => value,
...
pub unsafe extern "C" fn rm_crypto_ml_dsa_44_generate_keypair_from_seed(
    ...
    ffi_guard(|| {
        ...
        let (public, secret) =
            match crypto_ml_dsa_44::generate_ml_dsa_44_keypair_from_seed(secret_seed) {
                Ok(value) => value,
                Err(_) => return CRYPTO_INVALID_KEY,
            };
        let status = unsafe { write_fixed(public_out, public_out_len, &public) };
...
pub unsafe extern "C" fn rm_crypto_ml_dsa_44_sign(
    ...
    ffi_guard(|| {
        ...
        match crypto_ml_dsa_44::sign_ml_dsa_44(secret_seed, message) {
...
pub unsafe extern "C" fn rm_crypto_ml_dsa_44_verify(
    ...
    ffi_guard(|| {
        ...
        match crypto_ml_dsa_44::verify_ml_dsa_44(public_key, message, signature) {
            Ok(()) => CRYPTO_OK,
