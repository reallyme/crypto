...
/// FFI suite identifier for RSA/SHA-1 legacy verification.
...
pub unsafe extern "C" fn rm_crypto_rsa_verify_pkcs1v15(
    ...
    ffi_guard(|| {
        ...
        match crypto_rsa::verify_rsa_pkcs1v15(public_key_der, encoding, hash, message, signature) {
            Ok(()) => CRYPTO_OK,
...
pub unsafe extern "C" fn rm_crypto_rsa_verify_pss(
    ...
    ffi_guard(|| {
        ...
        match crypto_rsa::verify_rsa_pss(public_key_der, encoding, params, message, signature) {
            Ok(()) => CRYPTO_OK,
            Err(crypto_core::CryptoError::InvalidKey) => CRYPTO_INVALID_KEY,
            Err(_) => CRYPTO_INVALID_SIGNATURE,
        }
