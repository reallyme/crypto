...
pub const SHA3_224_DIGEST_LEN: usize = crypto_sha3::SHA3_224_DIGEST_LENGTH;
/// Length in bytes of a SHA3-384 digest (48).
pub const SHA3_384_DIGEST_LEN: usize = crypto_sha3::SHA3_384_DIGEST_LENGTH;
/// Length in bytes of a SHA3-512 digest (64).
pub const SHA3_512_DIGEST_LEN: usize = crypto_sha3::SHA3_512_DIGEST_LENGTH;
