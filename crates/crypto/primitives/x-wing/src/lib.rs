...
pub use decapsulate::{x_wing_1024_decapsulate, x_wing_768_decapsulate};
pub use encapsulate::{
    x_wing_1024_encapsulate, x_wing_1024_encapsulate_derand, x_wing_768_encapsulate,
...
pub use suite::{
    X_WING_1024_CIPHERTEXT_LEN, X_WING_1024_PUBLIC_KEY_LEN, X_WING_768_CIPHERTEXT_LEN,
