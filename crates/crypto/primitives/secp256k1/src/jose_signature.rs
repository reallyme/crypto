...
/// Converts a DER-encoded secp256k1 ECDSA signature to JOSE `r || s` form while
...
/// [`secp256k1_ecdsa_der_to_jose_signature`].
pub fn secp256k1_ecdsa_der_to_jose_signature_permissive(
    der: &[u8],
) -> Result<[u8; SECP256K1_ECDSA_JOSE_SIGNATURE_LEN], CryptoError> {
