...
use ml_kem::{
    ...
    ml_kem_512::DecapsulationKey,
    Seed,
};
use zeroize::{Zeroize, Zeroizing};

/// Length in bytes of the ML-KEM-512 decapsulation (secret) key seed.
...
/// Generate an ML-KEM-512 keypair deterministically from a 64-byte FIPS 203
/// seed (`d || z`).
