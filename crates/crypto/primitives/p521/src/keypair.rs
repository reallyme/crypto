...
pub fn generate_p521_keypair() -> (Vec<u8>, Zeroizing<Vec<u8>>) {
...
/// Derive a P-521 keypair from an existing 66-byte secret scalar.
///
/// This is intentionally named `from_secret_key`, not `from_seed`: the input
/// is already the private scalar material and must be a valid P-521 secret.
