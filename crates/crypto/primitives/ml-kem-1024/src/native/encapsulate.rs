...
pub fn ml_kem_1024_encapsulate(
    ...
    debug_assert_eq!(ct.len(), ML_KEM_1024_CIPHERTEXT_LEN);
...
/// Encapsulate to an ML-KEM-1024 public key using caller-supplied 32-byte
...
/// Decapsulate an ML-KEM-1024 ciphertext with the secret key seed.
///
...
pub fn ml_kem_1024_decapsulate(
    ...
    let ciphertext =
        Ciphertext::try_from(ciphertext).map_err(|_| CryptoError::InvalidCiphertextLength {
            minimum: ML_KEM_1024_CIPHERTEXT_LEN,
