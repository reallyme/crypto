...
use ml_kem::{
    ...
    ml_kem_1024::DecapsulationKey,
    Seed,
};
use zeroize::{Zeroize, Zeroizing};

/// Length in bytes of the ML-KEM-1024 decapsulation (secret) key seed.
...
/// Generate an ML-KEM-1024 keypair deterministically from a 64-byte FIPS 203
/// seed (`d || z`).
