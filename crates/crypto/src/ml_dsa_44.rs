...
//! ML-DSA-44 root facade routed through the signature operation layer.
...
/// Generate an ML-DSA-44 keypair through the signature operation owner.
...
/// Sign `message` with an ML-DSA-44 seed.
