...
fn encapsulate_with_rng(
    ...
    debug_assert_eq!(ct.len(), ML_KEM_512_CIPHERTEXT_LEN);
...
mod tests {
    ...
    fn fallible_encapsulation_matches_the_original_provider_algorithm() -> Result<(), CryptoError> {
        use ml_kem::{kem::Encapsulate, ml_kem_512::EncapsulationKey};

        let (public, _) = super::super::keypair::generate_ml_kem_512_keypair_from_seed(&[7; 64])?;
