...
///
/// Party information may contain stable, correlating identifiers. It is
/// deliberately non-cloneable and non-debuggable and zeroizes its owned bytes
/// on drop.
#[derive(Zeroize, ZeroizeOnDrop)]
...
pub fn derive_jwa_concat_kdf_sha256<const N: usize>(
    ...
    let other_info = Zeroizing::new(build_other_info(
